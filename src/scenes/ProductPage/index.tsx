  ...
  return (
    <div className="container px-4 py-24">
      <div className="relative flex flex-col md:flex-row justify-center gap-8">
        <div className="hidden md:block basis-1/2 lg:basis-auto space-y-4">{productImages}</div>
        ...
        <div className="sticky md:h-full md:top-80">
          <div className="space-y-6">
            ...
            <div>
              <button className="w-full bg-black hover:bg-black/80 text-white uppercase py-2">
                Add to Cart
              </button>
            </div>
          </div>
